...
class Data:
    ...
    def dump_meta(self, meta_type, select_set):
        ...
        #     """
        #     trips = self.trips[self.trips['set'] == select_set]
        ...
        #         trip_ids.append(trip_id)  # Save trip_id
        #     arrs, valid_lens = np.stack(arrs, 0), np.array(valid_lens)
        #     trip_ids = np.array(trip_ids, dtype=str)  # Convert to numpy array
        ...
        #     print(f"After normalize - arrs has nan: {np.isnan(arrs).any()}")
